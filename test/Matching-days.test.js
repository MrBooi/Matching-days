...
describe('The color change function', function() {

  it('should display "sameDay with color Green" property if user selected  same date ', function() {
    var matchingDay = MatchingDay();
    matchingDay.date1("2018-05-09");
    matchingDay.date2('2018-05-09"')
  ...
  it('should display "first with color Orange" property if user selected only first date ', function() {
    var matchingDay = MatchingDay();
    matchingDay.date1("2018-05-09");
    matchingDay.date2('2018-05-09"')
    let d1 = matchingDay.getDay1();
  ...
  it('should display "second with color Blue" property if user selected second date', function() {
    var matchingDay = MatchingDay();
    matchingDay.date1("");
  ...
  it('should display "first with color Orange and second with color Blue" property if user selected different dates', function() {
    var matchingDay = MatchingDay();
